...
type Props = {
  ...
  onApplyRating: (min: number | null) => void;
};
...
const PriceRatingFilter = observer(({
  ...
  const [localMinRating, setLocalMinRating] = useState(minRating?.toString() || '');
  ...
  return (
    <div className={styles.filter}>
      <div className={styles.filter__section}>
        <Text view="p-16" weight="bold" className={styles.filter__title}>Price</Text>
      ...
      <div className={styles.filter__section}>
        <Text view="p-16" weight="bold" className={styles.filter__title}>Rating</Text>
        <div className={styles.filter__row}>
          <Input
