    ...
    return (
        <header className={styles.header}>
            <div className={styles['header__container']}>
                ...
                {isMobile && (
                    <button
                        className={cn(styles.hamburger, { [styles.hamburgerOpen]: menuOpen })}
                ...
                {!isMobile && (
                    <nav className={styles['header__nav']}>
                        <Link
                            href="/products"
                            className={cn(styles['header__nav--link'], { [styles.active]: isActive('/products') })}
                        >
                            <Text className={cn(styles['header__nav--text'], { [styles.active]: isActive('/products') })}>
                                Products
                            </Text>
                        </Link>
                        <span className={styles['header__nav--link-disabled']}>
                        ...
                        <div className={styles['mobile-icons']}>
                            ...
                            >
                                ...
                                {authStore.isAuthenticated && WishlistStore.totalItems > 0 && (
                                    <span className={styles['header__icons--badge']}>{WishlistStore.totalItems}</span>
                                )}
                            </Link>
                            <Link
                            ...
                            {authStore.isAuthenticated ? (
                                ...
                                <Link href="/login" className={styles['header__icons--link--user']}>
                                    <UserIcon />
                                </Link>
                            )}
                        </div>
