...
const CartIcon: React.FC<IconProps> = (props) => {
  return (
    ...
    >
      ...
      />
      <path
        d="M9.375 9.58751 V8.37501 C9.375 5.56251 11.6375 2.80001 14.45 2.53751 C17.8 2.21251 20.625 4.85001 20.625 8.13751 V9.86251"
        stroke="currentColor"
        fill="none"
        strokeMiterlimit="10"
        strokeLinecap="round"
