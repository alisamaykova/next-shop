...
export const ProductList = observer(
  ({
    ...
    const { queryParamsStore } = useStore();
    const store = useLocalStore(
      () => new ProductListPageStore(queryParamsStore),
    );
      ...
      <div className={styles.root}>
        <div className={styles.root__header}>
          <div className={styles.root__title}>
            <Text
              className={styles["root__title--text"]}
              view="title"
              color="primary"
            >
              Products
          ...
          <div className={styles.root__subtitle}>
            <Text
              className={styles["root__subtitle--text"]}
              view="p-20"
              color="secondary"
            >
        ...
        <div className={styles["root__search--section"]}>
          <div className={styles["root__search--bar"]}>
            ...
            <Button
              className={styles["root__search--button"]}
          ...
          <div className={styles["root__price--rating--container"]}>
            <PriceRatingFilter
              className={styles["root__price--rating--filter"]}
          ...
          <div className={styles["root__total--products"]}>
            <Text
              className={styles["root__total--products--text"]}
              view="subtitle"
            >
              Total products
            </Text>
            <Text
              className={styles["root__total--text"]}
              view="p-20"
              weight="bold"
              color="accent"
            >
